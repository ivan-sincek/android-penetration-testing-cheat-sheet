...
* `permission` - look for hanging / unused [custom] permissions, and permissions with weak [protection](https://developer.android.com/guide/topics/manifest/permission-element) / `protectionLevel`,
* etc.
